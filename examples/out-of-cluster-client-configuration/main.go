...
import (
	...
	typedenterprisekgatewayv1alpha1 "github.com/solo-io/kgateway-client/v2/clientset/versioned/typed/v1alpha1/enterprisekgateway"
...
func main() {
	...
	flag.StringVar(&namespace, "namespace", defaultNamespace, "namespace to query")
	flag.Parse()
