...
// 	protoc        v3.15.8
// source: github.com/solo-io/rate-limiter/api/v1alpha1/ratelimit.proto
...
// LimitType specifies whether the global rate limit applies to requests, tokens, or cost.
// Defaults to REQUEST if not specified.
type LimitType int32

const (
	// Count the number of requests to apply ratelimit.
	LimitType_REQUEST LimitType = 0
	// Count the LLM tokens to apply ratelimit.
	// This field is only used for ratelimiting AI backends that emit a token count and is used by agentgateway.
	LimitType_TOKEN LimitType = 1
	// Count the USD cost (in micro-dollars, 1 unit = 0.000001 USD) to apply ratelimit.
	// The gateway passes an opaque integer cost increment; the rate-limiter does not know about
	// model catalogs or pricing rules.
	// For COST descriptors, use requests_per_unit_64 (field 10002) to express the budget in
	// micro-dollars (multiply USD by 1,000,000). requests_per_unit (field 2, uint32) is
	// retained for backwards compatibility but is ignored for COST limit types.
	// Example: a $10/day budget = requests_per_unit_64: 10000000
	// Maximum budget per window: 18,446,744,073,709,551,615 µUSD ≈ $18.4 quadrillion
	LimitType_COST LimitType = 2
)
...
func (LimitType) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_enumTypes[0].Descriptor()
}

func (LimitType) Type() protoreflect.EnumType {
	return &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_enumTypes[0]
}
...
func (LimitType) EnumDescriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{0}
}
...
func (RateLimitConfigStatus_State) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_enumTypes[1].Descriptor()
}

func (RateLimitConfigStatus_State) Type() protoreflect.EnumType {
	return &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_enumTypes[1]
}
...
func (RateLimitConfigStatus_State) EnumDescriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{1, 0}
}
...
func (RateLimit_Unit) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_enumTypes[2].Descriptor()
}

func (RateLimit_Unit) Type() protoreflect.EnumType {
	return &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_enumTypes[2]
}
...
func (RateLimit_Unit) EnumDescriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{6, 0}
}
...
func (MetaData_Source) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_enumTypes[3].Descriptor()
}

func (MetaData_Source) Type() protoreflect.EnumType {
	return &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_enumTypes[3]
}
...
func (MetaData_Source) EnumDescriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{8, 0}
}
...
func (x *RateLimitConfigSpec) Reset() {
	*x = RateLimitConfigSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[0]
...
func (x *RateLimitConfigStatus) Reset() {
	*x = RateLimitConfigStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RateLimitConfigStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{1}
}
...
func (x *Descriptor) Reset() {
	*x = Descriptor{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Descriptor) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{2}
}
...
func (x *SetDescriptor) Reset() {
	*x = SetDescriptor{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetDescriptor) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{3}
}
...
func (x *SimpleDescriptor) Reset() {
	*x = SimpleDescriptor{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SimpleDescriptor) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{4}
}
...
type RateLimitActions struct {
	...
	// Optional type defining the rate limit metric, such as requests, tokens, or cost.
	// The TOKEN type is only relevant for AI backends that emit a token count and is used by agentgateway.
	// The COST type is for USD budget accounting (µUSD counters) and requires requests_per_unit_64 on the RateLimit.
	// Defaults to REQUEST if not specified.
	Type LimitType `protobuf:"varint,4,opt,name=type,proto3,enum=ratelimit.solo.io.LimitType" json:"type,omitempty"`
}

func (x *RateLimitActions) Reset() {
	*x = RateLimitActions{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RateLimitActions) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{5}
}
...
func (x *RateLimitActions) GetType() LimitType {
	if x != nil {
		return x.Type
	}
	return LimitType_REQUEST
}
...
type RateLimit struct {
	...
	Unit RateLimit_Unit `protobuf:"varint,1,opt,name=unit,proto3,enum=ratelimit.solo.io.RateLimit_Unit" json:"unit,omitempty"`
	// For REQUEST and TOKEN limit types, this is the per-unit limit.
	// For COST limit types, use requests_per_unit_64 (field 10002) instead; this field
	// is ignored for COST to avoid uint32 overflow at budgets > ~$4,294.
	...
	// Optional type defining the rate limit metric, such as requests, tokens, or cost.
	// Uses a high field number to avoid collisions if Envoy extends this message.
	// For COST type, use requests_per_unit_64 to express the budget in µUSD (1 µUSD = 0.000001 USD).
	// Defaults to REQUEST if not specified.
	LimitType LimitType `protobuf:"varint,10001,opt,name=limit_type,json=limitType,proto3,enum=ratelimit.solo.io.LimitType" json:"limit_type,omitempty"`
	// For COST limit types only: the budget in micro-dollars (µUSD) as a uint64.
	// Uses a high field number to avoid collisions if Envoy extends this message.
	// 1 µUSD = 0.000001 USD. Maximum: ~$18.4 quadrillion.
	// This field is only read when limit_type == COST; ignored for REQUEST and TOKEN.
	RequestsPerUnit_64 uint64 `protobuf:"varint,10002,opt,name=requests_per_unit_64,json=requestsPerUnit64,proto3" json:"requests_per_unit_64,omitempty"`
}

func (x *RateLimit) Reset() {
	*x = RateLimit{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RateLimit) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{6}
}
...
func (x *RateLimit) GetLimitType() LimitType {
	if x != nil {
		return x.LimitType
	}
	return LimitType_REQUEST
...
func (x *RateLimit) GetRequestsPerUnit_64() uint64 {
	if x != nil {
		return x.RequestsPerUnit_64
	}
	return 0
}
...
func (x *Action) Reset() {
	*x = Action{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Action) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{7}
}
...
func (x *Action) GetCel() *Action_CEL {
	if x, ok := x.GetActionSpecifier().(*Action_Cel); ok {
		return x.Cel
	}
	return nil
}
...
type Action_Cel struct {
	// Rate limit on CEL expression. Only supported for agentgateway ratelimiting.
	Cel *Action_CEL `protobuf:"bytes,9,opt,name=cel,proto3,oneof"`
}
...
func (*Action_Cel) isAction_ActionSpecifier() {}
...
type MetaData struct {
	...
	// Source of metadata
	Source MetaData_Source `protobuf:"varint,4,opt,name=source,proto3,enum=ratelimit.solo.io.MetaData_Source" json:"source,omitempty"` // [(validate.rules).enum = {defined_only: true}];
}

func (x *MetaData) Reset() {
	*x = MetaData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MetaData) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{8}
}
...
func (x *Override) Reset() {
	*x = Override{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Override) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{9}
}
...
func (x *RateLimitConfigSpec_Raw) Reset() {
	*x = RateLimitConfigSpec_Raw{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RateLimitConfigSpec_Raw) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *Action_SourceCluster) Reset() {
	*x = Action_SourceCluster{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Action_SourceCluster) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{7, 0}
}
...
func (x *Action_DestinationCluster) Reset() {
	*x = Action_DestinationCluster{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Action_DestinationCluster) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{7, 1}
}
...
func (x *Action_RequestHeaders) Reset() {
	*x = Action_RequestHeaders{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Action_RequestHeaders) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{7, 2}
}
...
func (x *Action_RemoteAddress) Reset() {
	*x = Action_RemoteAddress{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Action_RemoteAddress) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{7, 3}
}
...
func (x *Action_GenericKey) Reset() {
	*x = Action_GenericKey{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Action_GenericKey) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{7, 4}
}
...
func (x *Action_HeaderValueMatch) Reset() {
	*x = Action_HeaderValueMatch{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Action_HeaderValueMatch) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{7, 5}
}
...
type Action_CEL struct {
	...
	Expression string `protobuf:"bytes,1,opt,name=expression,proto3" json:"expression,omitempty"` // [(validate.rules).string.min_bytes = 1];
	// The key to use in the descriptor entry.
	Key string `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"` // [(validate.rules).string.min_bytes = 1];
}

func (x *Action_CEL) Reset() {
	*x = Action_CEL{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[17]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Action_CEL) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Action_CEL) ProtoMessage() {}

func (x *Action_CEL) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Action_CEL.ProtoReflect.Descriptor instead.
func (*Action_CEL) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{7, 6}
}

func (x *Action_CEL) GetExpression() string {
	if x != nil {
		return x.Expression
	}
	return ""
...
func (x *Action_CEL) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *Action_HeaderValueMatch_HeaderMatcher) Reset() {
	*x = Action_HeaderValueMatch_HeaderMatcher{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[18]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Action_HeaderValueMatch_HeaderMatcher) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{7, 5, 0}
}
...
func (x *Action_HeaderValueMatch_HeaderMatcher_Int64Range) Reset() {
	*x = Action_HeaderValueMatch_HeaderMatcher_Int64Range{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[19]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Action_HeaderValueMatch_HeaderMatcher_Int64Range) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{7, 5, 0, 0}
}
...
func (x *MetaData_MetadataKey) Reset() {
	*x = MetaData_MetadataKey{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *MetaData_MetadataKey_PathSegment) Reset() {
	*x = MetaData_MetadataKey_PathSegment{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[21]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MetaData_MetadataKey_PathSegment) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{8, 0, 0}
}
...
func (x *Override_DynamicMetadata) Reset() {
	*x = Override_DynamicMetadata{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[22]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Override_DynamicMetadata) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{9, 0}
}
...
var File_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto protoreflect.FileDescriptor

var file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDesc = []byte{
	0x0a, 0x3c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x6f, 0x6c,
	0x6f, 0x2d, 0x69, 0x6f, 0x2f, 0x72, 0x61, 0x74, 0x65, 0x2d, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x65,
	0x72, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2f, 0x72,
	0x61, 0x74, 0x65, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11,
	...
	,
	...
	0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x12, 0x6f,
	0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x64, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x22, 0x30, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x50, 0x45,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x59, 0x45, 0x41, 0x52, 0x10, 0x06, 0x12, 0x08, 0x0a, 0x04, 0x57, 0x45, 0x45, 0x4b, 0x10, 0x07,
	0x22, 0xa4, 0x0c, 0x0a, 0x06, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x50, 0x0a, 0x0e, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x72, 0x61, 0x74, 0x65, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x2e,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x12, 0x5f, 0x0a,
	0x13, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x6c, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x72, 0x61, 0x74,
	0x65, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x41,
	...
	0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x12, 0x53,
	0x0a, 0x0f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x72, 0x61, 0x74, 0x65, 0x6c, 0x69,
	0x6d, 0x69, 0x74, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x41, 0x63, 0x74, 0x69,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x03, 0x65, 0x6e, 0x64, 0x42, 0x18, 0x0a, 0x16, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x5f, 0x6d,
	0x61, 0x74, 0x63, 0x68, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x4a, 0x04,
	0x08, 0x02, 0x10, 0x03, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x1a, 0x37, 0x0a, 0x03, 0x43, 0x45,
	0x4c, 0x12, 0x1e, 0x0a, 0x0a, 0x65, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18,
	...
	0x6b, 0x65, 0x79, 0x42, 0x12, 0x0a, 0x10, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x70,
	0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x22, 0x9f, 0x03, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61,
	0x44, 0x61, 0x74, 0x61, 0x12, 0x25, 0x0a, 0x0e, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74,
	0x6f, 0x72, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x64, 0x65,
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x6f, 0x72, 0x4b, 0x65, 0x79, 0x12, 0x4a, 0x0a, 0x0c, 0x6d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x27, 0x2e, 0x72, 0x61, 0x74, 0x65, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x2e, 0x73, 0x6f,
	...
	,
	...
	,
	...
	0x61, 0x31, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescOnce sync.Once
	file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescData = file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDesc
)

func file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescData = protoimpl.X.CompressGZIP(file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescData)
	})
	return file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDescData
}

var file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_goTypes = []interface{}{
	(LimitType)(0),                                           // 0: ratelimit.solo.io.LimitType
	(RateLimitConfigStatus_State)(0),                         // 1: ratelimit.solo.io.RateLimitConfigStatus.State
	(RateLimit_Unit)(0),                                      // 2: ratelimit.solo.io.RateLimit.Unit
	(MetaData_Source)(0),                                     // 3: ratelimit.solo.io.MetaData.Source
	(*RateLimitConfigSpec)(nil),                              // 4: ratelimit.solo.io.RateLimitConfigSpec
	(*RateLimitConfigStatus)(nil),                            // 5: ratelimit.solo.io.RateLimitConfigStatus
	(*Descriptor)(nil),                                       // 6: ratelimit.solo.io.Descriptor
	(*SetDescriptor)(nil),                                    // 7: ratelimit.solo.io.SetDescriptor
	(*SimpleDescriptor)(nil),                                 // 8: ratelimit.solo.io.SimpleDescriptor
	(*RateLimitActions)(nil),                                 // 9: ratelimit.solo.io.RateLimitActions
	(*RateLimit)(nil),                                        // 10: ratelimit.solo.io.RateLimit
	(*Action)(nil),                                           // 11: ratelimit.solo.io.Action
	(*MetaData)(nil),                                         // 12: ratelimit.solo.io.MetaData
	(*Override)(nil),                                         // 13: ratelimit.solo.io.Override
	(*RateLimitConfigSpec_Raw)(nil),                          // 14: ratelimit.solo.io.RateLimitConfigSpec.Raw
	(*Action_SourceCluster)(nil),                             // 15: ratelimit.solo.io.Action.SourceCluster
	(*Action_DestinationCluster)(nil),                        // 16: ratelimit.solo.io.Action.DestinationCluster
	(*Action_RequestHeaders)(nil),                            // 17: ratelimit.solo.io.Action.RequestHeaders
	(*Action_RemoteAddress)(nil),                             // 18: ratelimit.solo.io.Action.RemoteAddress
	(*Action_GenericKey)(nil),                                // 19: ratelimit.solo.io.Action.GenericKey
	(*Action_HeaderValueMatch)(nil),                          // 20: ratelimit.solo.io.Action.HeaderValueMatch
	(*Action_CEL)(nil),                                       // 21: ratelimit.solo.io.Action.CEL
	(*Action_HeaderValueMatch_HeaderMatcher)(nil),            // 22: ratelimit.solo.io.Action.HeaderValueMatch.HeaderMatcher
	(*Action_HeaderValueMatch_HeaderMatcher_Int64Range)(nil), // 23: ratelimit.solo.io.Action.HeaderValueMatch.HeaderMatcher.Int64Range
	(*MetaData_MetadataKey)(nil),                             // 24: ratelimit.solo.io.MetaData.MetadataKey
	(*MetaData_MetadataKey_PathSegment)(nil),                 // 25: ratelimit.solo.io.MetaData.MetadataKey.PathSegment
	(*Override_DynamicMetadata)(nil),                         // 26: ratelimit.solo.io.Override.DynamicMetadata
	(*wrapperspb.BoolValue)(nil),                             // 27: google.protobuf.BoolValue
}
var file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_depIdxs = []int32{
	14, // 0: ratelimit.solo.io.RateLimitConfigSpec.raw:type_name -> ratelimit.solo.io.RateLimitConfigSpec.Raw
	1,  // 1: ratelimit.solo.io.RateLimitConfigStatus.state:type_name -> ratelimit.solo.io.RateLimitConfigStatus.State
	10, // 2: ratelimit.solo.io.Descriptor.rate_limit:type_name -> ratelimit.solo.io.RateLimit
	6,  // 3: ratelimit.solo.io.Descriptor.descriptors:type_name -> ratelimit.solo.io.Descriptor
	8,  // 4: ratelimit.solo.io.SetDescriptor.simple_descriptors:type_name -> ratelimit.solo.io.SimpleDescriptor
	10, // 5: ratelimit.solo.io.SetDescriptor.rate_limit:type_name -> ratelimit.solo.io.RateLimit
	11, // 6: ratelimit.solo.io.RateLimitActions.actions:type_name -> ratelimit.solo.io.Action
	11, // 7: ratelimit.solo.io.RateLimitActions.set_actions:type_name -> ratelimit.solo.io.Action
	13, // 8: ratelimit.solo.io.RateLimitActions.limit:type_name -> ratelimit.solo.io.Override
	0,  // 9: ratelimit.solo.io.RateLimitActions.type:type_name -> ratelimit.solo.io.LimitType
	2,  // 10: ratelimit.solo.io.RateLimit.unit:type_name -> ratelimit.solo.io.RateLimit.Unit
	0,  // 11: ratelimit.solo.io.RateLimit.limit_type:type_name -> ratelimit.solo.io.LimitType
	15, // 12: ratelimit.solo.io.Action.source_cluster:type_name -> ratelimit.solo.io.Action.SourceCluster
	16, // 13: ratelimit.solo.io.Action.destination_cluster:type_name -> ratelimit.solo.io.Action.DestinationCluster
	17, // 14: ratelimit.solo.io.Action.request_headers:type_name -> ratelimit.solo.io.Action.RequestHeaders
	18, // 15: ratelimit.solo.io.Action.remote_address:type_name -> ratelimit.solo.io.Action.RemoteAddress
	19, // 16: ratelimit.solo.io.Action.generic_key:type_name -> ratelimit.solo.io.Action.GenericKey
	20, // 17: ratelimit.solo.io.Action.header_value_match:type_name -> ratelimit.solo.io.Action.HeaderValueMatch
	12, // 18: ratelimit.solo.io.Action.metadata:type_name -> ratelimit.solo.io.MetaData
	21, // 19: ratelimit.solo.io.Action.cel:type_name -> ratelimit.solo.io.Action.CEL
	24, // 20: ratelimit.solo.io.MetaData.metadata_key:type_name -> ratelimit.solo.io.MetaData.MetadataKey
	3,  // 21: ratelimit.solo.io.MetaData.source:type_name -> ratelimit.solo.io.MetaData.Source
	26, // 22: ratelimit.solo.io.Override.dynamic_metadata:type_name -> ratelimit.solo.io.Override.DynamicMetadata
	6,  // 23: ratelimit.solo.io.RateLimitConfigSpec.Raw.descriptors:type_name -> ratelimit.solo.io.Descriptor
	9,  // 24: ratelimit.solo.io.RateLimitConfigSpec.Raw.rate_limits:type_name -> ratelimit.solo.io.RateLimitActions
	7,  // 25: ratelimit.solo.io.RateLimitConfigSpec.Raw.set_descriptors:type_name -> ratelimit.solo.io.SetDescriptor
	27, // 26: ratelimit.solo.io.Action.HeaderValueMatch.expect_match:type_name -> google.protobuf.BoolValue
	22, // 27: ratelimit.solo.io.Action.HeaderValueMatch.headers:type_name -> ratelimit.solo.io.Action.HeaderValueMatch.HeaderMatcher
	23, // 28: ratelimit.solo.io.Action.HeaderValueMatch.HeaderMatcher.range_match:type_name -> ratelimit.solo.io.Action.HeaderValueMatch.HeaderMatcher.Int64Range
	25, // 29: ratelimit.solo.io.MetaData.MetadataKey.path:type_name -> ratelimit.solo.io.MetaData.MetadataKey.PathSegment
	24, // 30: ratelimit.solo.io.Override.DynamicMetadata.metadata_key:type_name -> ratelimit.solo.io.MetaData.MetadataKey
...
func init() { file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_init() }
func file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_init() {
	if File_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Action); i {
			case 0:
				return &v.state
			case 1:
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Action_CEL); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
	...
	file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*RateLimitConfigSpec_Raw_)(nil),
	}
	file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[7].OneofWrappers = []interface{}{
	...
	file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[9].OneofWrappers = []interface{}{
		(*Override_DynamicMetadata_)(nil),
	}
	file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[18].OneofWrappers = []interface{}{
	...
	file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes[21].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDesc,
			NumEnums:      4,
			NumMessages:   23,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_goTypes,
		DependencyIndexes: file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_depIdxs,
		EnumInfos:         file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_enumTypes,
		MessageInfos:      file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_msgTypes,
	}.Build()
	File_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto = out.File
	file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_rawDesc = nil
	file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_goTypes = nil
	file_github_com_solo_io_rate_limiter_api_v1alpha1_ratelimit_proto_depIdxs = nil
}
