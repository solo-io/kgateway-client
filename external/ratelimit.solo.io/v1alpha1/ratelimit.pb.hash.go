...
func (m *RateLimitConfigSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.RateLimitConfigSpec")); err != nil {
		return 0, err
	}
...
func (m *RateLimitConfigStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.RateLimitConfigStatus")); err != nil {
		return 0, err
	}
...
func (m *Descriptor) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.Descriptor")); err != nil {
		return 0, err
	}
...
func (m *SetDescriptor) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.SetDescriptor")); err != nil {
		return 0, err
	}
...
func (m *SimpleDescriptor) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.SimpleDescriptor")); err != nil {
		return 0, err
	}
...
func (m *RateLimitActions) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.RateLimitActions")); err != nil {
		return 0, err
	}
...
func (m *RateLimit) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.RateLimit")); err != nil {
		return 0, err
	}
	...
	err = binary.Write(hasher, binary.LittleEndian, m.GetLimitType())
	if err != nil {
		return 0, err
	}

	err = binary.Write(hasher, binary.LittleEndian, m.GetRequestsPerUnit_64())
	if err != nil {
		return 0, err
	}
...
func (m *Action) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.Action")); err != nil {
		return 0, err
	}
	...
	case *Action_Cel:
		...
		if h, ok := interface{}(m.GetCel()).(safe_hasher.SafeHasher); ok {
			if _, err = hasher.Write([]byte("Cel")); err != nil {
				return 0, err
			}
			if _, err = h.Hash(hasher); err != nil {
				return 0, err
			...
			if fieldValue, err := hashstructure.Hash(m.GetCel(), nil); err != nil {
				return 0, err
			} else {
				if _, err = hasher.Write([]byte("Cel")); err != nil {
					return 0, err
...
func (m *MetaData) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.MetaData")); err != nil {
		return 0, err
	}
...
func (m *Override) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.Override")); err != nil {
		return 0, err
	}
...
func (m *RateLimitConfigSpec_Raw) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.RateLimitConfigSpec_Raw")); err != nil {
		return 0, err
	}
...
func (m *Action_SourceCluster) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_SourceCluster")); err != nil {
		return 0, err
	}
...
func (m *Action_DestinationCluster) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_DestinationCluster")); err != nil {
		return 0, err
	}
...
func (m *Action_RequestHeaders) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_RequestHeaders")); err != nil {
		return 0, err
	}
...
func (m *Action_RemoteAddress) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_RemoteAddress")); err != nil {
		return 0, err
	}
...
func (m *Action_GenericKey) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_GenericKey")); err != nil {
		return 0, err
	}
...
func (m *Action_HeaderValueMatch) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_HeaderValueMatch")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *Action_CEL) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_CEL")); err != nil {
		return 0, err
	}

	if _, err = hasher.Write([]byte(m.GetExpression())); err != nil {
		return 0, err
	}
...
func (m *Action_HeaderValueMatch_HeaderMatcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_HeaderValueMatch_HeaderMatcher")); err != nil {
		return 0, err
	}
...
func (m *Action_HeaderValueMatch_HeaderMatcher_Int64Range) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_HeaderValueMatch_HeaderMatcher_Int64Range")); err != nil {
		return 0, err
	}
...
func (m *MetaData_MetadataKey) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.MetaData_MetadataKey")); err != nil {
		return 0, err
	}
...
func (m *MetaData_MetadataKey_PathSegment) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.MetaData_MetadataKey_PathSegment")); err != nil {
		return 0, err
	}
...
func (m *Override_DynamicMetadata) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/rate-limiter/pkg/api/ratelimit.solo.io/v1alpha1/types.Override_DynamicMetadata")); err != nil {
		return 0, err
	}
